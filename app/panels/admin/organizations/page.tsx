...
export default function OrganizationManagementPage() {
  ...
  async function refreshOrganizations() {
    ...
    try {
      ...
      console.error("Refresh organizations error:", err);
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="bg-slate-900/50 backdrop-blur-sm rounded-2xl shadow-xl border border-slate-800 p-6 mb-6">
          ...
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search by name, display ID, email, or description..."
              value={searchQuery}
                ...
                {filteredOrgs.length === 0 ? (
                  <tr>
                    <td colSpan={5} className="p-12 text-center">
                      <Building2 className="w-16 h-16 mx-auto text-slate-700 mb-3" />
                    ...
                    >
                      ...
                      <td className="p-4">
                        <div className="flex justify-end gap-2">
                          <button
                            className="p-2 text-blue-400 hover:bg-blue-400/20 rounded-lg transition-all hover:scale-110"
                            title="Camera Setup"
                            onClick={() =>
                              router.push(
                                `/panels/admin/organizations/${org.id}`,
                              )
                            }
                          >
