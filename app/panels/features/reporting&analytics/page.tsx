...
const detectionTrendData = [
  {
    ...
    armFlailing: 45,
    erraticMovements: 32,
    facialExpressions: 28,
    thermalIndicators: 12,
    fallDetection: 5,
    escapeAttempts: 2,
    staffDetection: 60,
  },
  {
    ...
    armFlailing: 52,
    erraticMovements: 38,
    facialExpressions: 31,
    thermalIndicators: 15,
    fallDetection: 6,
    escapeAttempts: 3,
    staffDetection: 65,
  },
  {
    ...
    armFlailing: 48,
    erraticMovements: 35,
    facialExpressions: 29,
    thermalIndicators: 14,
    fallDetection: 7,
    escapeAttempts: 2,
    staffDetection: 62,
  },
  ...
  },
  {
    ...
    armFlailing: 67,
    erraticMovements: 48,
    facialExpressions: 41,
    thermalIndicators: 20,
    fallDetection: 9,
    escapeAttempts: 5,
    staffDetection: 75,
  },
  {
    ...
    armFlailing: 59,
    erraticMovements: 44,
    facialExpressions: 37,
    thermalIndicators: 17,
    fallDetection: 7,
    escapeAttempts: 3,
    staffDetection: 72,
  },
...
const alertDistribution = [
  { name: "Arm Flailing", value: 13, color: "#ec4899" },
  { name: "Erratic Movements", value: 19, color: "#ef4444" },
  { name: "Facial Expressions", value: 10, color: "#f59e0b" },
  { name: "Thermal Indicators", value: 7, color: "#14b8a6" },
  { name: "Fall Detection", value: 3, color: "#a78bfa" },
  { name: "Escape Attempts", value: 2, color: "#fbbf24" },
  { name: "Staff Detection", value: 45, color: "#6366f1" },
];

const cameraPerformance = [
  { camera: "Analytics 1", uptime: 99.8, detections: 234, alerts: 12 },
  { camera: "Analytics 2", uptime: 98.5, detections: 189, alerts: 8 },
  { camera: "Analytics 3", uptime: 100, detections: 156, alerts: 5 },
];
...
const reports = [
  ...
  {
    id: 2,
    title: "Enabled Features Analytics",
    type: "Weekly Report",
    date: "Jan 1-7, 2026",
    size: "5.8 MB",
    icon: FileText,
  ...
  {
    id: 3,
    title: "Monthly Detection Review",
    type: "Monthly Report",
    date: "December 2025",
    size: "12.3 MB",
    icon: FileText,
